/*
    ESTE METODO SE EJECUTA CUANDO YA HAY UNA REFERENCIA AL COMPONENTE EXISTENTE
    ASI COMO TAMBIEN PODEMOS HACER REFERENCIAS A LIBRERIAS EXTERNAS OH A APIS
*/
